  	...
  	render(){
    	...
    	return (
    		<div className="container test">
      		...
      		<h3>All information provided by this application respectfully sourced 
      		    from Heads Up CDC program.  Additional information, resources, 
      		    materials, and training can be found at their website.</h3>

		      <h3><a href="https://www.cdc.gov/HeadsUp" target="_blank">https://www.cdc.gov/HeadsUp</a></h3>

		      <h3>The National Alliance for Youth Sports Concussion Training</h3>
		      ...
		      <h3>Evidence-based sideline concussion screening offered in association with the Mayo Clinic</h3>

		      <h3><a href="https://kingdevicktest.com" target="_blank">https://kingdevicktest.com</a></h3>

		      <h3>Matthew Gfeller Sport-Related Traumatic Brain Injury Research Center at UNC-Chapel Hill</h3>

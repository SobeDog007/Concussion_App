    		...
    		<div className="mainbox">
    			<div className="titlebox">
	      		...
	      		<h1 className="heading">What is "Head In The Game"?</h1>
	        		...
	        		<p>Head In The Game is an website devoted to helping parents/coaches easily and efficiently 
	        		   diagnose concusions or other sports related head trauma.  We feel its valuable due to the 
	        		   increasing understanding of the seriousness of brain damage or potential brain damage 
	        		   related to contact sports.  On a basic level this app would help parents or coaches to 
	        		   diagnose the injury to the athlete and take appropriate action.</p>
      		</div>
      		...
      		<div className="factbox">
	      		...
	      		<h2 className="heading">Concussion Facts</h2>
	        		...
	        		<p>A concussion is a type of traumatic brain injury (TBI) caused by a bump, blow, or 
	        		   ...
	        		   or twist in the skull, creating chemical changes in the brain and sometimes 
